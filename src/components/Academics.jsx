...
import deptvid from "../assets/AOT_dept.mp4"
import Cse from "./Cse";
      ...
      <div
        ...
        <section className="vid-con w-full h-screen  bg-center bg-no-repeat bg-cover">
          <div className="rounded-xl w-full h-full xl:flex xl:justify-center xl:items-center xl:mx-auto z-[-100] fixed">
            <video autoPlay loop muted src={deptvid} className="vid w-full h-screen overflow-hidden object-cover filter brightness-[50%] blur-sm contrast-125 "/>
        ...
        <div className="h-full w-full bgdept">
          ...
          <div className="page-content-ug p-4">
            <div className="card">
              <div className="content">
                ...
                <button class="btn"><NavLink to={"/Cse"}>Know more</NavLink></button>
              </div>
            </div>
            <div className="card">
              <div className="content">
