  ...
  return (
    ...
    >
      ...
      <div className="group-hover/bento:translate-x-4 transition duration-200 ">
        {icon}
        <div className="font-sans text-xs md:text-lg font-bold text-neutral-600 dark:text-neutral-200 mb-2 mt-2 ">
          {title}
        </div>
        <div className="font-sans font-normal text-neutral-600 text-xs dark:text-neutral-300 text-wrap">
          {description}
        </div>
      </div>
    </div>
